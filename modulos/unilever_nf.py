...
def executar_interface_nf():
    file_path = CONFIG["unilever_nf"]["file_path"]
    sheet = CONFIG["unilever_nf"]["sheet"]
    header = CONFIG["unilever_nf"].get("header", 1)
    emails_df_path = CONFIG["unilever_nf"]["emails_path"]
...
"""
    ...
    root = tk.Tk()
    root.title("Cobrança de NF – Unilever")
